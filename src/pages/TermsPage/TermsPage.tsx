  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        <span> ContactBook</span> (“we,” “us” or “our”), concerning your access
        to and use of the <span>[website name.com]</span>
      ...
      <p>
        <span>
          <strong>Option 2</strong>: [The Site is intended for users who are at
      ...
      <p>
        ...
        you do so at your own risk, and you should be aware these Terms and
      ...
      <p>
        ...
        Policy <span>[CLICK HERE]/posted on the Site]</span>. By using the Site,
        you agree to be bound by our Privacy Policy, which is incorporated into
        these Terms and Conditions. Please be advised the Site is hosted in the
        United States.
      </p>
      <p>
      ...
      <p>
        ...
        <span>[us/our Designated Copyright Agent] </span>using the contact
      ...
      <p>
        ...
        provided below) informally for at least <span>______</span>
      ...
      <p>
        ...
        the AAA website <a href="https://www.adr.org">www.adr.org</a>.
      </p>
      <p>
      ...
      <p>
        ...
        courts located in <span>[name of county]</span>
        County, <span>[name of state]</span>, and the Parties hereby consent to,
      ...
      <p>
        ...
        <span>_____</span> years after the cause of action arose. If this
      ...
      <p>
        ...
        the Site or Services be commenced more than <span>______</span> years
      ...
      <p>
        <strong>
          ...
          <span>[Informal Negotiations and]</span>
          Arbitration
        </strong>
      </p>
      <p>
      ...
      <p>
        <span>[Corporate Fax Number]</span>
      </p>
      <p>
